...
2. `2026-03-18T20:03-07:00` | `producer contract shape` | `medium` | `research-agent entities.json is not a WhyGame-native contract. A narrow transformation step was needed to map source entity relationships into WhyGame RELATIONSHIP facts.` | `First generated a run-local WhyGame fact file manually, then added and proved a narrow CLI helper: convert-research-agent-entities-to-whygame.` | `Keep the producer-specific helper narrow and resist turning it into a generalized external-schema framework.`
