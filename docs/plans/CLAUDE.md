...
| 0025 | [Cross-Document Entity Resolution](0025_cross_document_entity_resolution.md) | In progress (value proof plus eight bounded hardening passes complete; Plan 0039 active for rerun-stability cleanup) |
...
| 0039 | [24h Entity Resolution Rerun Stability Block](0039_24h_entity_resolution_rerun_stability_block.md) | Active (turn the best `0038` rerun into a repeatable fresh-run result) |
